...
int detect_collision_firebeam(bounding_box_t a, float x, float y, float angle);
int detect_collision_semi(bounding_box_t a, float x,float y);


extern float screen_zoom, screen_center_x, screen_center_y,player_max_x;
void reset_screen(double);
